...
import com.bezkoder.springjwt.models.response.MessageResponse;
import com.bezkoder.springjwt.repository.RoleRepository;
import com.bezkoder.springjwt.repository.UserRepository;
import com.bezkoder.springjwt.security.jwt.JwtUtils;
import com.bezkoder.springjwt.services.Details.UserDetailsImpl;
...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    UserEntity user = new UserEntity(signUpRequest.getUsername(), 
              ...
              signUpRequest.getSurname(), signUpRequest.getCell(), 
              signUpRequest.getBirthDate(), signUpRequest.getProfileImg(),
              signUpRequest.getCreditCard(), signUpRequest.getCvv(),
              signUpRequest.getExpire(), signUpRequest.getHolder());
